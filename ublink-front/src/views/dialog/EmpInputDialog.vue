            ...
            <template v-slot:default>
              ...
              <tbody>
                <tr v-for="(item, i) in list" :key="i">
                  <td class="text-left">
                    <div class="pr5">
                      <v-text-field v-model="item.DEPT_NM" hide-details solo outlined flat dense
                  ...
                  <td class="text-left pl5">
                    <div class="pl5">
                      <v-text-field v-model="item.EMP_NM" hide-details solo outlined flat dense
